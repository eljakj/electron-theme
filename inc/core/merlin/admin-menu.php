                    ...
                    <div class="c-inner">
                        ...
                        if ( isset( $_POST['ninetheme_deactivate_licence'] ) ) {
                            wp_remote_post('https://api.ninetheme.com/deactivate', array(
                                ...
                                'body' => array(
                                    'purchase_code' => trim( get_option('envato_purchase_code_48852413') ),
                                    'theme_name' => 'electron',
                            ...
                            if ( get_option('envato_purchase_code_48852413') ) {
                                delete_option('envato_purchase_code_48852413');
                            }
                        }

                        if ( false == get_option('envato_purchase_code_48852413') ) {
                            update_option( 'ninetheme_deactivated_licence', 'yes' );
                            ?>
                            <h4 class="c-title"><?php esc_html_e( 'Activate License', 'zank' ); ?></h4>
                            <p class="c-text"><?php esc_html_e( 'Envato allows 1 license for 1 project located on 1 domain. It means that 1 purchase key can be used only for 1 site. Each additional site will require an additional purchase key.', 'zank' ); ?></p>
                            <p class="c-text"><?php esc_html_e( 'Please click to connect your license and enter your purchase code.', 'zank' ); ?></p>
                            ...
                            <h4 class="c-title"><?php esc_html_e( 'Disconnect License', 'zank' ); ?></h4>
                            <p class="c-text"><?php esc_html_e( 'If you want to use this template on another server, click the disconnect button here. When you disconnect, this creates a registration and a list of domains for which you used the purchase code will be saved. In case of illegal use of licenses, there is a risk that your Envato account will be deleted or your purchase code will be canceled. Do not share your license code with anyone other than our support team.', 'zank' ); ?></p>
                            ...
                            <form class="deactivate-form" method="post">
                                <button type="submit" class="button button-primary ninetheme-deactivate-licence" name="ninetheme_deactivate_licence">
                                    <?php esc_html_e( 'Disconnect', 'zank' ); ?>
                                </button>
                            </form>
                            <?php
                        }
