    ...
    <div class="col-12 col-md-10 col-lg-5">
        ...
        <form method="post" class="woocommerce-ResetPassword lost_reset_password">
            ...
            <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first electron-flex">
                <label for="user_login"><?php esc_html_e( 'Username or email', 'electron' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'electron' ); ?></span></label>
